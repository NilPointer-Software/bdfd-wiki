...
Unlike its counterpart variables (e.g. [`$setVar`](./setVar.md), [`$setUserVar`](./setUserVar.md), etc.) which require you to create a variable in the app, [`$var[]`](./var.md) doesn't require that.
